...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
   ...
   /**
     ...
     * @return null|PHPExcel_Cell Cell that was found/created or null
     */
	public function getCellByColumnAndRow($pColumnIndex = 0, $pRow = 1, $createIfNotExists = true)
    {
        $pColumn = PHPExcel_Cell::stringFromColumnIndex($pColumnIndex);
        $coordinate = $pColumn . $pRow;
